...
def process_echo_nest(echo_nest_metadata = 'data_echonest/Echo_Nest_metadata.txt'):
    echo_nest_path=Path(echo_nest_metadata)
    ### Load data_echonest/Echo_Nest_metadata.txt
...
def main(overwrite = False, out_path = "data_echonest"):
    """
